...
fun MainScreen() {
    ...
    val missingScope = remember { HookRegistry.packagesMissingFromScope() }
...
private fun ScopeCard() {
    val packages = ModuleScope.packages
    Card(
...
private val unusedColorReference: Color = Color.Unspecified
