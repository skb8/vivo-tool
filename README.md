...
| Новая панель громкости | `com.android.systemui` | Включает новый стиль громкости OriginOS 5 (`VivoVolumeNewImpl`): капсулу-полоску у края экрана и пружинные анимации |
...
│   ├── systemui/                       хуки интерфейса системы (SystemUI)
